"""Vendorizado de hzwer/Practical-RIFE (MIT License), versão 4.25 --
https://github.com/hzwer/Practical-RIFE/blob/main/train_log/IFNet_HDv3.py --
só o import do `warp` foi ajustado pro caminho local (`.warplayer`)."""
