...
export function themeToCssVars(theme: ThemeSettings): Record<string, string> {
  return {
    ...
    '--btn-border-width': `${theme.button_border_width_px ?? 2}px`,
    ...
    '--color-pdp-buy-bg': theme.pdp_buy_button_bg_color,
    '--color-pdp-buy-fg': theme.pdp_buy_button_text_color,
    '--color-pdp-buy-hover': theme.pdp_buy_button_hover_color,
    '--color-pdp-buy-border': theme.pdp_buy_button_border_color,
    '--radius-pdp-buy': `${theme.pdp_buy_button_radius_px ?? 12}px`,
    '--pdp-buy-border-width': `${theme.pdp_buy_button_border_width_px ?? 2}px`,
